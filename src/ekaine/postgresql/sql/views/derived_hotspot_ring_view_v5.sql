...
select
    ...
    hs.commodity_sym as hotspot_commodity_sym,
...
create index if not exists hotspot_ring_view_hotspot_commodity_sym_id
on derived.hotspot_ring_view (hotspot_commodity_sym);
