...
create index on derived.acquisition_routes (vector_id);
create index on derived.acquisition_routes (vector_state);
create index on derived.acquisition_routes (target_id);
create index on derived.acquisition_routes (target_state);
create index on derived.acquisition_routes (target_population);
create index on derived.acquisition_routes (target_body_count);
create index on derived.acquisition_routes (target_primary_economy);
create index on derived.acquisition_routes (controlling_faction_id);
create index on derived.acquisition_routes (ring_type);
create index on derived.acquisition_routes (commodity_sym);
create index on derived.acquisition_routes (station_name);
create index on derived.acquisition_routes (sell_price);
create index on derived.acquisition_routes (demand);
create index on derived.acquisition_routes (market_updated_at);
