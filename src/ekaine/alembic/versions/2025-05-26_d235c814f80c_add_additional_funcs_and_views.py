...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("sy_cf_id", sa.Integer(), nullable=False),
        sa.Column("sy_cf_state", sa.Text(), nullable=False),
        sa.Column("sy_cf_active_states", sa.ARRAY(sa.Text()), nullable=True),
        sa.Column("station_id", sa.Integer(), nullable=False),
        sa.Column("st_cf_id", sa.Integer(), nullable=False),
        sa.Column("st_cf_state", sa.Text(), nullable=False),
